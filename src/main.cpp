...
int main( int argc, char* args[] )
{
    ...
    SDL_Window* gWindow = initWindow();

    SDL_Renderer* gRenderer = initRenderer( gWindow );
    ...
    {
        // load media
        if( !loadMedia( gRenderer, &gDotTexture, &gObsTexture, &gTextTexture, gFont ) )
        {
    ...
    close( gWindow, gRenderer, gDotTexture, gObsTexture, gTextTexture, gFont );
